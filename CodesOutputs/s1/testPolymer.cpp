...
int main(int argc,char *argv[])
{
     ...
     /*  ------  Set up parameters  ------ */
    // Sampling parameters
    int npts = 4e7 ;   // how many points to generate
    int dsave = 4;         // how often to save points
    
    // Stratification parameters
    int n = 6;        // number of spheres
    int dim = 3;      // dimension of spheres
    double kappa = 2;  // sticky parameter for off-backbone spheres
    VectorXd params(3);
    params << n,dim,kappa;
    int whichcase = 0;
    ...
    // filename
    string filehead("PolymerStrat_s1");
    ...
    // Proposal parameters
    int seed = -2026232535;     // = 0 for random seed (based on clock time)
    double sig = 0.4;
